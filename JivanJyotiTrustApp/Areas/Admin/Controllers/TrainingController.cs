...
public class TrainingController : Controller
{
    ...
    public async Task<IActionResult> Create(TrainingFormViewModel model)
    {
        ...
        var training = new Training { CityId = model.CityId.Value, Location = model.Location.Trim(), Description = model.Description.Trim() };
    ...
    public async Task<IActionResult> Edit(int id)
    {
        ...
        return View("Form", await BuildFormAsync(new TrainingFormViewModel { Id = item.Id, CityId = item.CityId, Location = item.Location, Description = item.Description, ExistingGalleryItems = item.GalleryItems.ToList() }));
    }
    ...
    public async Task<IActionResult> Edit(int id, TrainingFormViewModel model)
    {
        ...
        item.CityId = model.CityId.Value; item.Location = model.Location.Trim(); item.Description = model.Description.Trim();
        await _context.SaveChangesAsync();
